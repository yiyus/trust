...
* `dinc`: Multiplier to increment damping factor after rejected guess (default `1E2`)
* `ddec`: Multiplier to decrement damping factor after accepted guess (default `dinc*÷¯2`)
